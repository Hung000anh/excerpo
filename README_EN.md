...
* **Multi-platform:** Supports scanning and downloading from a wide range of online reading platforms grouped by country:
  ...
  - <img src="https://flagcdn.com/w20/us.png" width="16" alt="US"> **US / Global:** `ao3`, `cardboardtranslation`, `fictionpress`, `foxaholic`, `freewebnovel`, `lnmtl`, `noveldex`, `novelight`, `novellunar`, `royalroad`, `scribblehub`, `wattpad`.
