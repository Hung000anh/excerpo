...
* **Multi-platform:** Supports scanning and downloading from a wide range of online reading platforms grouped by country:
  ...
  - <img src="https://flagcdn.com/w20/tw.png" width="16" alt="TW"> **Taiwan (Traditional):** `69shuba.tw`, `alicesw`, `czbooks`, `po18`, `sto9`, `sto55`, `ttkan`, `twkan`. AliceSW example: `https://www.alicesw.tw/novel/53104.html`.
